...
<table width="90%" class="container mt-3" border="1">
 ...
 <tr>
  ...
  <center><a target="_blank" class="btn  btn-default btn-sm" href="{{asset('storage/surat_permohonan_lesen/' . $post->surat_permohonan_lesen)}} "><i class="fas fa-folder"></i></a></center>
      ...
      <td><div class="gallery">
      <iframe src="{{asset('storage/lesen_jualan/' . $post->lesen_jualan)}} " alt="lesen_jualan" width="100%" height="100%"></iframe></div>
  <center><a target="_blank" class="btn  btn-default btn-sm" href="{{asset('storage/lesen_jualan/' . $post->lesen_jualan)}} "><i class="fas fa-folder"></i></a></center>
  ></td>    
 </tr></div><div> <tr>
