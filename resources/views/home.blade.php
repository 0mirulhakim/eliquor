...
?>
<?php
  $sql_qry="SELECT COUNT(*) as count FROM permohonan WHERE YEAR(tarikh) = YEAR(CURDATE())";
...
?>
<?php
  $sql_qry="SELECT COUNT(*) as count FROM permohonan WHERE status_permohonan_id='3' AND YEAR(tarikh) = YEAR(CURDATE())";
...
?>
<?php
  $sql_qry="SELECT COUNT(*) as count FROM permohonan WHERE status_permohonan_id='4' AND YEAR(tarikh) = YEAR(CURDATE())";
