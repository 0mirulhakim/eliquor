...
class Sah2Controller extends Controller
{
    /**
    ...
    {
        $posts = DB::select('SELECT * FROM permohonan where status_permohonan_id="2" AND jenis_permohonan="3"');
        //$posts = Post::orderBy('title','desc')->take(1)->get();
        //$posts = Post::orderBy('title','desc')->get();
       //$posts=  Post::orderBy('created_at','asc')->paginate(10);
        return view('sah2.index')->with('posts',$posts);
    }
